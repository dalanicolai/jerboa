...
(and useful) sketch. You are welcome to contribute 🙏
...
(evil-global-set-key 'normal "m" 'jerboa-bind)

;; Jump to bookmark (invokes the jerboa keymap)
(evil-global-set-key 'motion "'" jerboa-map)

;; Unbind keys
(evil-global-set-key 'normal "M" 'jerboa-unbind))
#+end_src
...
Call 'jerboa-bind' (=m= is suggested for evil-user).
